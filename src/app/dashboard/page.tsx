...
export default function Dashboard() {
  const [userData, setUserData] = useState<GameData | null>(null);
  const [editableData, setEditableData] = useState<GameData>({
    username: "",
    gold: 0,
    gems: 0,
    level: 1,
  ...
  const handleChange = (
    field: keyof Omit<GameData, "username" | "profilePic">,
    value: number
  ) => {
